...
export default function EpisodesView(): JSX.Element {
  ...
  return (
    <>
      ...
      {episodes
      .filter(episode => episode.name.toLocaleLowerCase().includes(searchBarText.toLocaleLowerCase())||episode.summary.toLocaleLowerCase().includes(searchBarText.toLocaleLowerCase()))
      .map((episode) => {
